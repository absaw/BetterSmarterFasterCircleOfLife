...
class VPartialAgent:
    ...
    def simulate_step(self,prey : Prey,predator:Predator):
        ...
        for ag_neighbor in agent_neighbors:
            ...
            #     print("nan detected")
            agent_action_utility[ag_neighbor]=utility #we will store the utility in here
...
#Used for testing. Not part of the main flow. VPartialAgent simulator will call VPartialAgent
if __name__=="__main__":
    ...
    agent_three=VPartialAgent(n_nodes, G, prey, predator)
