...
class NeuralNetwork:
    ...
    def initialize_weights(self):
        ...
        self.BW3=np.random.randn(self.layer_list[3],)
    ...
    def forward_propogation(self):
        ...
        # print("\n3rd")
        self.Z3=np.dot(self.A2,self.W3)#+self.bias3*self.BW3
    ...
    def back_propogation(self):
        ...
        # self.dBW3=np.sum(self.delta_3,axis=0,keepdims=True)
        ...
        # self.BW3=self.BW3+alpha*self.dBW3
        ...
        self.parameters["BW2"]=self.BW2
        # self.parameters["BW3"]=self.BW3
        self.parameters["dBW1"]=self.dBW1
        self.parameters["dBW2"]=self.dBW2
        # self.parameters["dBW3"]=self.dBW3
...
def plot_graph(x,y,plot_name,xlabel,ylabel):
    plt.title(plot_name)
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    plt.plot(x,y)
...
if __name__=="__main__":
    ...
    with open('StoredWeights/param_dict_partial.pkl', 'rb') as handle:
        data = handle.read()
    ...
    # file = open("StoredWeights/param_dict_partial.pkl", "wb")
    # pickle.dump(NN.parameters, file)

    # # file.close()
    # plot_name="Model V Partial - Mean Square Error vs No. of Iterations"
